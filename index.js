...
const deviceCert = {
  cert: fs.readFileSync('/home/pi/iotsafefleet/certificate-hackathon-x509_cert.pem').toString(),
  key: fs.readFileSync('/home/pi/iotsafefleet/certificate-hackathon-x509_key.pem').toString()
};
